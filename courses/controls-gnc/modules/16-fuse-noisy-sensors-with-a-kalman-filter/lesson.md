...
Fuse noisy position samples with a deterministic constant-velocity Kalman filter. This native lab preserves the source teaching objective in a bounded Python model; the course fidelity record names behavior that is intentionally not exposed in the platform.
