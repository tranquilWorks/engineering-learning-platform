...
Trade position regulation against command effort with a discrete LQR design. This native lab preserves the source teaching objective in a bounded Python model; the course fidelity record names behavior that is intentionally not exposed in the platform.
