...
Connect gain/phase margins to ringing and instability in the same transparent loop. This native lab preserves the source teaching objective in a bounded Python model; the course fidelity record names behavior that is intentionally not exposed in the platform.
