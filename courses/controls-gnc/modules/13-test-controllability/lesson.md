...
Use rank and reachability energy to distinguish weak from missing control authority. This native lab preserves the source teaching objective in a bounded Python model; the course fidelity record names behavior that is intentionally not exposed in the platform.
