...
- P02-P10 are Python-first native designs because the corresponding source folders are non-runnable scaffolds.
...
- Software plots do not establish learner, browser/accessibility, physical robot, HIL, bench, field, release, deployment, or production evidence.
