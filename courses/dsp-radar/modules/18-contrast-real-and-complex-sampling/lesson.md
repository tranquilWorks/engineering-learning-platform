# P18 Lesson: Frequency Sign Is Rotation Direction
...
## Use the source-faithful Python experiment: Contrast Real and Complex Sampling

Vary **frequency offset** and **sample rate** independently. Centered spectra and adjacent complex phase steps preserve sign, including aliases on the signed discrete-time interval at 512 and 256 samples/s. Broken mode discards Q, making conjugate rotations the same real cosine and collapsing both sign estimates. Recovery retains the full I+jQ measurement.
