# P16 Lesson: Magnitude Gives Phase a Reliable Direction
...
## Use the source-faithful Python experiment: Create an Analytic Signal with the Hilbert Transform

The implementation writes the even-length FFT Hilbert mask directly: retain DC and Nyquist, double positive frequencies, and zero negative-frequency redundancy. Sweep **envelope depth** and **phase deviation** separately. Broken mode creates the retained near-zero amplitude notch and shows the raw phase-derivative spike. Recovery withholds estimates unless both adjacent analytic samples exceed 0.05 V.
